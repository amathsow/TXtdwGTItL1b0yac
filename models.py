...
def stat_ml_models(df, data_name, X_train, y_train, X_test, y_test, scores_dict):
    ...
    prophet_model_name, prophet_model_mae, prophet_y_pred = prophet_model(df, data_name)
    scores_dict['Model'].append(prophet_model_name)
    scores_dict['Test Score'].append(prophet_model_mae)
    return arima_model_name, arima_y_pred, sarima_model_name, sarima_y_pred, arimax_model_name, arimax_y_pred, prophet_model_name, prophet_y_pred
